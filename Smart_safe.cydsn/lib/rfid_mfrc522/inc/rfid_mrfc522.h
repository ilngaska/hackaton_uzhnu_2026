 ...
 * ========================================
*/
#ifndef RFID_MRFC522_H
#define RFID_MRFC522_H
...
typedef void   (*rfid_write_ptr)(u_char, u_char);
typedef u_char (*rfid_read_ptr)(u_char);
typedef void   (*rfid_rst)(uint8_t state);
typedef void   (*rfid_mdelay_ptr)(uint32_t millisec);

typedef struct rfid_ctx
{
  /** Component mandatory fields **/
  rfid_write_ptr   write_reg;
  rfid_read_ptr    read_reg;
  rfid_rst         rst;
  rfid_mdelay_ptr  mdelay;
} rfid_ctx_t;
