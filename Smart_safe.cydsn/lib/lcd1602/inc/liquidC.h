...
typedef struct
{
  ...
  void LCDI2C_begin(uint8_t cols, uint8_t rows);//, uint8_t charsize = LCD_5x8DOTS ); if you use another character size, adjust it here and in the function documentation
  void LCDI2C_clear();
  void LCDI2C_home();
